...
export class EmailComponent {
  ...
  public generateEmail(){
    ...
    this.emailPara2 = "Professor, I have gone through many of your works but specially '" + this.researchArea + "' has been particularly inspiring to me, and I believe your guidance could be invaluable as I am very much interested in " + this.field + ". That's why I am reaching you out.";
